...
//     const tableSuffix = fctTable.sufix;
//     const {
//         columns,
//         uniqueAssertion,
//         nonNullAssertion
//     } = require(`definitions/staging/fct/stg_${tableSuffix}.js`);
...
fctTables.forEach(fctTable => {
    publishSilverTableFromStagingViews(fctTable, 'fct', true)
})
